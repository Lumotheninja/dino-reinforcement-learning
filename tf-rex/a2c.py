...
if __name__ == "__main__":
    ...
    for i_episode in range(num_episodes):
        ...
        # Save weights
        if i_episode%50==0:
            torch.save(policy_net.state_dict(), 'dino_a2c_reward_%.1f_ep_%d.pt'%(cum_rewards,i_episode))
    ...
    # env.close()
    plt.ioff()
    plt.savefig("dino_a2c_final.png")
    torch.save(policy_net.state_dict(), 'dino_a2c_final.pt')